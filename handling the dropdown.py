...
options=driver.find_elements('xpath','//select[@id="country"]/option')
print(len(options))
...
driver.find_element('xpath','//select[@id="country"]').click()
time.sleep(2)
driver.find_element('xpath','//select/option[@value="canada"]').click()
driver.find_element('xpath','//select[@id="country"]').click()
time.sleep(5)